...
s1_p = L*str2num(num2str(val{6,2})).';                            % defining P and Q for CD GCon
s2_q = str2num(val{7,2}).';
...
%%
makeVideo(Phi_q,q,qbar,qdot,q_dot,qddot,q_ddot,ts)
